...
HD_PWD='F:/FPGA_Project/02_breath_key_led/prj/breath_key_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log breath_key_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source breath_key_led.tcl -notrace
