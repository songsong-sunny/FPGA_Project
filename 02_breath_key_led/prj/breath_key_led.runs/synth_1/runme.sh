...
HD_PWD='F:/FPGA_Project/02_breath_key_led/prj/breath_key_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breath_key_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breath_key_led.tcl
